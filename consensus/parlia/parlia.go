...
func (p *Parlia) getCurrentValidators(blockHash common.Hash) ([]common.Address, error) {
	...
	result, err := systemCall(ctx, ethapi.CallArgs{
		Gas:  &gas,
		To:   &toAddress,
		Data: &msgData,
	}, blockNr, nil)
...
func (p *Parlia) distributeIncoming(val common.Address, state *state.IntraBlockState, header *types.Header, chain core.ChainContext,
...
// slash spoiled validators
func (p *Parlia) slash(spoiledVal common.Address, state *state.IntraBlockState, header *types.Header, chain core.ChainContext,
	txs *[]*types.Transaction, receipts *[]*types.Receipt, receivedTxs *[]*types.Transaction, usedGas *uint64, mining bool) error {
	// method
	method := "slash"
...
// init contract
func (p *Parlia) initContract(state *state.IntraBlockState, header *types.Header, chain core.ChainContext,
	txs *[]*types.Transaction, receipts *[]*types.Receipt, receivedTxs *[]*types.Transaction, usedGas *uint64, mining bool) error {
	// method
	method := "init"
	// contracts
...
func (p *Parlia) distributeToSystem(amount *big.Int, state *state.IntraBlockState, header *types.Header, chain core.ChainContext,
	txs *[]*types.Transaction, receipts *[]*types.Receipt, receivedTxs *[]*types.Transaction, usedGas *uint64, mining bool) error {
	// get system message
...
func (p *Parlia) distributeToValidator(amount *big.Int, validator common.Address,
	state *state.IntraBlockState, header *types.Header, chain core.ChainContext,
	txs *[]*types.Transaction, receipts *[]*types.Receipt, receivedTxs *[]*types.Transaction, usedGas *uint64, mining bool) error {
	// method
	method := "deposit"
